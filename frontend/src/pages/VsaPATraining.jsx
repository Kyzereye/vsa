...
function VsaPATraining() {
  ...
  useEffect(() => {
    fetchEvents("trainingPA", { past: true })
      .then(setPast)
      ...
      <main>
        <section className="hero hero-auth" id="home">
          <div className="hero-content">
            <h1>VSA-PA Training</h1>
            <p style={{ opacity: 0.95 }}>Firearms and safety courses from the VSA Pennsylvania chapter</p>
